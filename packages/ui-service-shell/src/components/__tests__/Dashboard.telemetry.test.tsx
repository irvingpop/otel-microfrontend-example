...
describe('Dashboard Telemetry Integration', () => {
  ...
  describe('Session Initialization', () => {
    it('should initialize session trace on mount', () => {
      render(<Dashboard />)
      
      expect(telemetry.getOrCreateSessionTrace).toHaveBeenCalledTimes(1)
    })

    it('should track initial weather widget activation on mount', () => {
      render(<Dashboard />)
  ...
  describe('Telemetry Call Sequence', () => {
    it('should maintain correct order of telemetry calls', () => {
      render(<Dashboard />)
